...
if __name__ == '__main__':
    # 输出路径
    jpgs_path = "./JPEGImages"  # 原图像存储文件夹
    pngs_path = "./SegmentationClass"  # 生成的标签png存储文件夹

    # classes第一个和固定为_background_，后面的和cityscapes2voc文件中的target_label一样就可以
    classes = ["_background_", 'sky', 'person', 'vegetation', 'terrain', 'car', 'building', 'ground', 'road']
